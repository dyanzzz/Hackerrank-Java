...
public class JavaCurrencyFormatter {
    public static void main(String[] args) {
        ...
        String us = currencyFormater(Locale.US, payment);
        String india = currencyFormater(ind, payment);
        String china = currencyFormater(Locale.CHINA, payment);
        String france = currencyFormater(Locale.FRANCE, payment);
    ...
    static String currencyFormater(Locale locale, double value) {
